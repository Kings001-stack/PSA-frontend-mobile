...
const InventoryImportScreen: React.FC = () => {
    ...
    const handleUpload = async () => {
        ...
        try {
            ...
            Alert.alert('Import Complete', `Successfully imported ${response.data.imported} items.`);
        } catch (error: any) {
            console.error('Upload failed:', error);
            const errorMessage = error.response?.data?.message || 'Failed to upload and import CSV.';
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.content}>
                ...
                <View style={styles.uploadSection}>
                    <TouchableOpacity
                        style={[styles.pickerBtn, file && !file.canceled && styles.pickerBtnActive]}
                        onPress={pickDocument}
                    >
                        <Ionicons
                            name={file && !file.canceled ? "document-text" : "cloud-upload-outline"}
                            size={48}
                    ...
                    <TouchableOpacity
                        style={[styles.uploadBtn, (!file || file.canceled || isUploading) && styles.uploadBtnDisabled]}
                        ...
                        <View style={styles.resultHeader}>
                            ...
                            <View style={styles.statRow}>
                                <View style={[styles.statBadge, { backgroundColor: '#f0fdf4' }]}>
                                    <Text style={[styles.statText, { color: '#16a34a' }]}>{result.imported} Success</Text>
                                </View>
                                <View style={[styles.statBadge, { backgroundColor: '#fef2f2' }]}>
                                    <Text style={[styles.statText, { color: '#dc2626' }]}>{result.failed} Failed</Text>
                                </View>
                            </View>
                        </View>
