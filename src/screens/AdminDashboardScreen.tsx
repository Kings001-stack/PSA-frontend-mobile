...
import { View, Text, StyleSheet, ScrollView, RefreshControl, TouchableOpacity, ActivityIndicator, StatusBar, Platform, Alert } from 'react-native';
            ...
            <View style={[styles.header, { paddingTop: insets.top }]}>
                <View style={styles.headerGlass}>
                    ...
                    <View style={styles.adminBrief}>
                        <View>
                            <Text style={styles.roleTag}>SUPERUSER PORTAL</Text>
                            <Text style={styles.adminWelcome}>{user?.name}</Text>
                        </View>
            ...
            >
                ...
                <View style={styles.statsGrid}>
                    ...
                    <View style={styles.statCard}>
                        ...
                        <Text style={styles.statValue}>${stats?.total_value || 0}</Text>
                    ...
                    <View style={styles.statCard}>
                        ...
                        <Text style={styles.statValue}>{stats?.expiring_soon || 0}</Text>
                    ...
                    <View style={styles.alertsContainer}>
                        ...
                        {alerts.map(item => (
                            <View key={item.id} style={styles.alertItem}>
                                <Text style={styles.alertName}>{item.medication.name}</Text>
                                <View style={styles.alertBadge}>
                                    <Text style={styles.alertBadgeText}>{item.quantity} left</Text>
                                </View>
                            </View>
                        ))}
                    </View>
                ...
                >
                    ...
                    <View>
                        <Text style={[styles.actionTitle, { color: '#dc2626' }]}>Sign Out</Text>
                        <Text style={styles.actionSubtitle}>Securely exit your account</Text>
                    </View>
                </TouchableOpacity>
...
const styles = StyleSheet.create({
    ...
    statsGrid: {
        ...
        justifyContent: 'space-between',
        marginBottom: 24,
        marginTop: 10, // Added positive space instead of overlap
    },
    statCard: {
        width: '48%',
